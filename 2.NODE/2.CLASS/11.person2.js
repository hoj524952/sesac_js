...
class Employee extends Person {
    ...
    work() {
        console.log(`${this.name}이 ${this.jobTitle}의 일을 열심히 하고 있음.`)
    }
}
...
class Student extends Person {
    ...
    study(){
        console.log(`${this.name}이 전공인 ${this.major}를 열심히 공부하고 있음.`)
    }
}

const student1 = new Student('루루', 23, '여성', '1234123', '예술');
student1.greet();
student1.study();